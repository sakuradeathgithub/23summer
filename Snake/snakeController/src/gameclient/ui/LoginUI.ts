...
private usernameInput: egret.TextField = null;
        private passwordInput: egret.TextField = null;
        private nicknameInput: egret.TextField = null;
        public inButton: egret.TextField = null;
        public upButton: egret.TextField = null;

        public nickname: string = null;
        public username:string = null;
        public password:string = null;

        private stageWidth = 512;
        ...
        private init(){
            ...
            let texture = RES.getRes("bg_jpg");
            let bg = new egret.Bitmap(texture);
            bg.alpha = 0.5;
            this.addChild(bg);
            ...
            let signIn = new egret.TextField();
            signIn.text = "登录";
            ...
            let signUp = new egret.TextField();
            signUp.text = "注册";
        ...
        public addInButtonEventListener(eventName:string, eventFun: Function, eventObject: any): void{
            this.inButton.addEventListener(eventName, eventFun, eventObject);
        }

       private onFocusIn(event: egret.Event){
        ...
        private onFocusOut(event: egret.Event){
            let target = event.currentTarget;
